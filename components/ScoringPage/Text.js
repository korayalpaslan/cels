      ...
      >
        ...
        <h1 className="text-secondary lg:text-primary font-bold text-xl lg:text-4xl">
          ...
          <p className="mt-4 lg:mt-6 lg:text-xl max-w-[1000px] mx-auto">
            The CELS <span className="font-light">&reg;</span>competency scale
            comprises five proficiency levels. These levels come with verbal
            explanations of the abilities expected from students based on their
            test results. Level one signifies minimal proficiency, whereas level
            5 denotes a strong proficiency. Students achieving levels 4 and 5
            usually excel in English-instructed courses with minimal or no need
