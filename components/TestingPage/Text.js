      ...
      >
        ...
        <h1 className="text-secondary lg:text-primary font-bold text-xl lg:text-4xl">
          ...
          <p className="mt-4 lg:mt-6 lg:text-xl max-w-[1000px] mx-auto">
            The CELS® Test is a standardized exam created to assess the
            listening and reading comprehension abilities of English language
            learners in high school. It aims to gauge students' capacity to
            handle the English language demands within secondary school courses
