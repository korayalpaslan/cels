    ...
    >
      <div className="mb-16">
        ...
        <p className="mt-4 lg:mt-6 lg:text-xl">
          The CELS <span className="font-light">&reg;</span> TEST evaluates the
          English language proficiency of secondary school students in both
          social and academic contexts, with a predominant focus on academic
          language. The test measures reading comprehension and listening
          comprehension skills. The operational definition of "academic
          language" is the language used in educational services in schools.
        </p>
      </div>
        ...
        <div className="w-full lg:w-2/3 mb-8 lg:mb-8 lg:pr-32">
          <div className="text-left">
            ...
            <ul className="text-left list-disc ml-5 font-light">
              ...
              <li className="mb-2">
                Content Management Language - the general academic language used
                to discuss academic tasks and class content (e.g., discussion,
                explanation, and comparison).
              </li>
              <li className="mb-2">
                Domain-Specific Language - a specialized academic language used
                to express ideas in content areas (e.g., communication,
